<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:68:"/home/aptx/File/PHP/6rmh/public/../app/index/view/address/index.html";i:1508832185;s:68:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/user.html";i:1508832926;s:67:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/top.html";i:1510619768;s:65:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./user/nav.html";i:1508832185;s:70:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/footer.html";i:1508832185;}*/ ?>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<div class="user-panel address" data-ng-controller="addrCtrl">
    <div class="more-info-navbar wp_100 ">
        <ul  >
            <li>
                ...
                <span class="hint-str">
                        您已创建
                        <span id="addressNum_top" class="hint-int"><?php echo $count; ?></span>
                        个收货地址，最多可创建
    ...
    <div class="wp_100" >
        ...
        <div class="user-address f_l">
            ...
            <div class="wp_60 f_l l_h_30">
                <span class="middle-label"><?php echo $vo['name']; ?></span><br>
                <span class="middle-label"><?php echo $vo['addr']; ?></span><br>
                <span class="middle-label"><?php echo $vo['address']; ?></span><br>
                <span class="middle-label"><?php echo $vo['mobile']; ?></span><br>
                <span class="middle-label"><?php echo $vo['zipcode']; ?></span>
            </div> 
            <div class="t_r f_l wp_90 l_h_30">
                <span class="ctrl-option"><input type="radio" name="checked" value="">&nbsp;&nbsp;默认地址</span>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="<?php echo url('edit',['id' => $vo['id']]); ?>"><span class="ctrl-option">编辑</span></a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="<?php echo url('del',['id' => $vo['id']]); ?>"><span class="ctrl-option">删除</span></a>
            </div>
        </div>
    ...
    <div class="wp_100" >
        ...
        <form  method="post" name="form" action="<?php echo url('add'); ?>">
