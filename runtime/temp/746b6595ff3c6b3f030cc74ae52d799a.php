<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"/home/aptx/File/PHP/6rmh/public/../app/index/view/balance/withdraw.html";i:1510619768;s:68:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/user.html";i:1508832926;s:67:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/top.html";i:1510619768;s:65:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./user/nav.html";i:1508832185;s:70:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/footer.html";i:1508832185;}*/ ?>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<form class="form-horizontal" method="post" role="form" action="<?php echo url('opwithdraw'); ?>">
<div class="user-panel address">
    ...
    <div class="wp_100">
        ...
        <div class="wp_50  f_l m_t50">
            ...
            <div class="wp_100 m_t l_h_50">
                <span class="wp_20 f_l t_r main_font_color f_c">密码：</span>
                <span class="wp_80 f_l t_l main_font_color"><input class="w280 h30 main_font_color input_border" type="text" name="pay_code" value=""></span>   
            </div>
        </div>
        <div class="wp_25  f_l"></div>
...
<div class="user-panel address">
    ...
    <div class="more-info-detail wp_100" >
        ...
        <div class="withdraw wp_100" <?php if($vo['status']==3): ?>title="驳回理由：<?php echo $vo['opreason']; ?>"<?php endif; ?> >
            <div class="wp_25 f_l"><?php echo $vo['addtime']; ?></div>
            <div class=" wp_15 f_l"><?php echo $vo['name']; ?></div>
            <div class="font-color-sub_main wp_15 f_l">¥ <?php echo $vo['value']; ?></div>
            <div class="wp_15 f_l">
                <?php if($vo['type'] == 1): ?>
                电脑端
                <?php else: ?>
            ...
            <div class=" wp_20 f_l"><?php echo $vo['terminal']; ?></div>
            <div class=" wp_10 f_l"> 
                <?php if($vo['status'] == 1): ?>
                申请提现
