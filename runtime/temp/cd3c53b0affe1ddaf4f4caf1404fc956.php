<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"/home/aptx/File/PHP/6rmh/public/../app/index/view/balance/recharge.html";i:1510619768;s:68:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/user.html";i:1508832926;s:67:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/top.html";i:1510619768;s:65:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./user/nav.html";i:1508832185;s:70:"/home/aptx/File/PHP/6rmh/public/../app/index/view/./public/footer.html";i:1508832185;}*/ ?>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<form class="form-horizontal" method="post" role="form" action="<?php echo url('opRecharge'); ?>">
...
<div class="user-panel address">
    ...
    <div class="more-info-detail wp_100" >
        ...
        <div class="withdraw wp_100" <?php if($vo['status']==3): ?>title="驳回理由：<?php echo $vo['opreason']; ?>"<?php endif; ?> >
            <div class="wp_15 f_l"><?php echo $vo['order_id']; ?></div>
            <div class="wp_20 f_l"><?php echo date('Y-m-d H:i:s',$vo['addtime']); ?></div>
            <div class=" wp_15 f_l"><?php echo $vo['name']; ?></div>
            <div class="font-color-sub_main wp_10 f_l">¥ <?php echo $vo['money']; ?></div>
            <div class="wp_15 f_l">
                <?php if($vo['type'] == 1): ?>
                电脑端
                <?php else: ?>
            ...
            <div class=" wp_15 f_l"><?php echo $vo['terminal']; ?></div>
            <div class=" wp_10 f_l"> 
                <?php if($vo['status'] == 1): ?>
                申请充值
